...
//		"studyreport-manager": "components/studyreport-manager",
		...
		"d3_tip": "d3.tip",
		"jnj_chart": "jnj.chart",
		"lodash": "lodash_4_11_1",
//		"lodash": "lodash.min",
//		"lodash_4_11_1": "lodash_4_11_1",
		"lscache": "lscache.min",
...
requirejs(['bootstrap'], function () { // bootstrap must come first
	...
	requirejs(['knockout', 'app', 'appConfig', 'director', 'localStorageExtender', 'jquery.ui.autocomplete.scroll'], function (ko, app, config) {
		$('#splash').fadeIn();
